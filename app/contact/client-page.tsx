...
// Formspree configuration - Zero-setup email service with CORS support
const FORMSPREE_FORM_ID = "maqqdqlw"
...
export default function ContactPageClient() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Send via Formspree - CORS-enabled, zero-setup email service
